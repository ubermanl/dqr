...
paths:
  ...
  /status/getSuggested/{moduleId}:
    get:
      ...
      description: "This method will query the suggested state (on/off) of a module\
        \ at current time."
      operationId: "get_suggested_state"
      produces:
      - "application/json"
      parameters:
      - name: "moduleId"
  ...
  /status/getSuggestedChange/{moduleId}:
    get:
      ...
      operationId: "get_suggested_state_change"
      produces:
      - "application/json"
      parameters:
      - name: moduleId
  ...
  /status/query/{deviceId}:
    get:
      ...
      operationId: "query_device_state"
      produces:
      - "application/json"
      parameters:
      - name: "deviceId"
  ...
  /status/change/{moduleId}:
    get:
      ...
      operationId: "change_module_state"
      produces:
      - "application/json"
      parameters:
        - name: moduleId
